...
class Karma extends \Taeram\Bot {
   ...
   * @param integer $chat The chat id
   *
   * @return self
   */
   ...
   * @param integer $chat The chat id
   * @param integer $maxResults The number of results to return
   *
   ...
   * @param integer $change The karma delta, positive or negative
   *
   * @return bool
   */
